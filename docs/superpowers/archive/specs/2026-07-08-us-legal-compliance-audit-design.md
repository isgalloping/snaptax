...
**Date:** 2026-07-08  
**Status:** Approved (brainstorming, revised) · **Implemented** (2026-07-08)  
...
- [x] Operator block on all `docs/legal/*.md` (Gang Huang, Hong Kong)
- [x] Public brand **SnapTax** in legal/marketing/app title (`manifest`, `layout`, i18n)
- [x] `cookies.md` + `disclaimer.md` via `LegalMarkdownPage`
- [x] Policies hub + footer Cookie / Disclaimer / Do Not Sell
- [x] Footer Do Not Sell → `/privacy#no-sale` (heading slug strips § number)
- [x] Refund: 14-day US window in `refund.md`
- [x] Terms: Paddle MoR in `terms.md` / `refund.md`
- [x] `lib/legal/operator.ts` constants
- [x] `docs/ops/us-compliance-checklist.md`
- [ ] Paddle URL smoke on production domain (manual)
- [ ] External counsel sign-off (out of scope)
