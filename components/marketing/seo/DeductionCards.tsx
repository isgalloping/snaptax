...
import { MockupLineIcon } from "@/components/marketing/seo/mockupIcons";
    ...
    <section id="deductions" className="scroll-mt-24 border-t border-white/10">
      <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6">
        <h2
          className={
            isMockup
              ? "text-center text-2xl font-black tracking-tight text-white sm:text-3xl"
        ...
        <ul
          className={
            isMockup
              ? "mt-10 grid list-none gap-4 sm:grid-cols-2 lg:grid-cols-4"
              : "mt-10 grid list-none gap-4 sm:grid-cols-2 lg:grid-cols-3"
          }
        >
            ...
            >
              {isMockup ? (
                <>
                  ...
                  >
                    <MockupLineIcon name={card.title} />
                  </div>
