...
Privacy Policy · Terms · **Data Retention** · **Security** · **Data storage（美国）** · snaptax.lightxforge@gmail.com · **Delete Account**（Sheet 确认；未登录清本地+Ghost 服务端数据；已登录 `DELETE /api/users/me`）
...
访问/导出 · Delete Account · snaptax.lightxforge@gmail.com（**30 天**法定响应；**48 小时**内确认收悉）· DSR 内部流程见 `docs/ops/dsr-playbook.md`
