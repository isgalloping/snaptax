...
SnapTax and Snap1099 refer to the same application ("the App"). By using the App, you agree to these Terms. If you do not agree, do not use the App.

## 1. Agreement & Service Description

SnapTax helps contractors, self-employed workers, and small businesses **organize receipts**, **track expenses**, and **prepare export reports for tax season**. The App uses AI to assist with categorization and produces files (for example CSV, PDF, ZIP, or TXF) that you or your tax professional may review.

The App is a **recordkeeping and export tool**, not tax, legal, or accounting advice. We do **not** file taxes, provide official government forms, or guarantee audit outcomes. Consult a qualified CPA or advisor for your tax obligations.

## 2. Operator

The App is operated by the service provider reachable at **legal@snap1099.com** ("we", "us", "our"). Legal notices and privacy requests should be sent to that address.
...
## 6. Export Reports & Limitations

"Tax-ready" and similar labels in the App mean **organized export files formatted for review** — not that any authority or software has approved them.

- Exports are **for your records and review** with your CPA or tax software.
- We do **not** warrant that exports will be accepted by the IRS, any state agency, TurboTax, or other software.
- You are responsible for verifying amounts, categories, and deductions before filing.

## 7. Intellectual Property

SnapTax, Snap1099, logos, and software are owned by us or our licensors. You retain ownership of your receipt content. You grant us a limited license to process your receipts solely to provide the Service.

## 8. Disclaimer & Tax Estimates
