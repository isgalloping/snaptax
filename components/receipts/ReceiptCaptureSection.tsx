    ...
    <section>
      ...
      {imageSrc ? (
        <button
          type="button"
          onClick={onZoom}
          className="relative block min-h-32 w-full overflow-hidden rounded-xl border border-zinc-600 bg-zinc-950 active:scale-[0.99]"
        >
          ...
          />
          <span className="pointer-events-none absolute bottom-2 right-2 rounded bg-black/70 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wide text-zinc-400">
            {hint}
          </span>
        </button>
      ) : (
