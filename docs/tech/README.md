...
| 7d | [../superpowers/topics/receipt-sync-lifecycle-design.md](../superpowers/topics/receipt-sync-lifecycle-design.md) | **Receipt sync lifecycle：Event Store、orphan Ghost merge、post-login sync 顺序** |
| 8 | [07-paddle-billing.md](./07-paddle-billing.md) | Paddle 支付与权益 |
| 9 | [08-export.md](./08-export.md) | Tax Pack 多格式导出 |
...
| 模块 | 现状 | 目标 |
|------|------|------|
| 身份 UI | Google 软/硬引导 + Ghost API + Google GIS | Ghost → Google bind + orphan Ghost merge |
