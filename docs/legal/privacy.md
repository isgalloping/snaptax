...
- **Receipt images** you snap.
- **Extracted metadata:** merchant, date, amount, category, and similar fields from AI processing.
- **Identity data:** email and display name **only if you use Google Sign-In**.
...
All transfers use **TLS 1.3**. OpenAI processing is disclosed as a sub-processor in our vendor agreements.
...
We safeguard international data transfers using industry-standard encryption (**TLS 1.3** and **AES-256** at rest where supported by our cloud providers) and rely on appropriate transfer mechanisms, including compliance by our infrastructure partners with the **EU-U.S. Data Privacy Framework** where applicable.

## 5. No Sale of Personal Data

- **Zero ads.**
- We **never sell or share** your financial or receipt data with marketers, insurers, or data brokers.
- Revenue comes only from your voluntary tax-season export purchase.

## 6. Your Rights

Under GDPR and CPRA you may:

- **Access / export** receipts in the App or via the tax-season export.
- **Delete** all data via **Delete Account** in Settings (irreversible; removes server and local data tied to your session or account).
